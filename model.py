...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://root:GaussdbPassword@123@119.3.126.0:5432/postgres'
...
class Vote(db.Model):
    ...
    post_id = db.Column(db.Integer, ForeignKey('post.post_id'), primary_key=True)
    account_id = db.Column(db.Integer, ForeignKey('account.account_id'), primary_key=True)
